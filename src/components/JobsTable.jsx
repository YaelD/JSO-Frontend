...
import { filterAndSortPositions } from "../utils/utilities";
...
export default function JobsTable({ positions }) {
  ...
  const sortedPositions = useMemo(() =>
    filterAndSortPositions(positions, filterStatus, order),
    [order, positions, filterStatus]
  );
